...
use FactorioItemBrowser\Export\Command\Export\AbstractExportModCommand;
...
/**
 * The PHPUnit test of the AbstractExportModCommand class.
 *
 * @author BluePsyduck <bluepsyduck@gmx.com>
 * @license http://opensource.org/licenses/GPL-3.0 GPL v3
 * @coversDefaultClass \FactorioItemBrowser\Export\Command\Export\AbstractExportModCommand
 */
class AbstractExportModCommandTest extends TestCase
{
    use ReflectionTrait;
    ...
    public function testConstruct(): void
    {
        ...
        /* @var AbstractExportModCommand|MockObject $command */
        $command = $this->getMockBuilder(AbstractExportModCommand::class)
