...
use FactorioItemBrowser\Export\Command\Export\ExportModWithDependenciesCommandFactory;
...
/**
 * The PHPUnit test of the ExportModWithDependenciesCommandFactory class.
 *
 * @author BluePsyduck <bluepsyduck@gmx.com>
 * @license http://opensource.org/licenses/GPL-3.0 GPL v3
 * @coversDefaultClass \FactorioItemBrowser\Export\Command\Export\ExportModWithDependenciesCommandFactory
 */
class ExportModWithDependenciesCommandFactoryTest extends TestCase
{
    /**
     * Tests the invoking.
     * @covers ::__invoke
    ...
    public function testInvoke(): void
    {
        ...
        $factory = new ExportModWithDependenciesCommandFactory();
        $factory($container, ExportModWithDependenciesCommand::class);
    }
}
