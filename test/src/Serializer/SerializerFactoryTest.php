...
namespace FactorioItemBrowserTest\Export\Serializer;
 ...
 * @coversDefaultClass \FactorioItemBrowser\Export\Serializer\SerializerFactory
 */
class SerializerFactoryTest extends TestCase
{
    ...
    public function testInvoke(): void
    {
        ...
        /* @var \FactorioItemBrowser\ExportData\Serializer\SerializerFactory&MockObject $factory */
            ...
            ConfigKey::PROJECT => [
                ConfigKey::EXPORT => [
                    ConfigKey::DIRECTORIES => [
                        ConfigKey::DIRECTORY_CACHE => $cacheDir,
                    ],
                ],
            ],
        ];
