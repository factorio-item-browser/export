...
class ReducedExportDataServiceFactoryTest extends TestCase
{
    ...
    {
        $config['export-data']['reduced']['directory'] = 'abc';
        ...
        $result = $factory($container, ReducedExportDataService::class);
        $this->assertInstanceOf(ReducedExportDataService::class, $result);
    }
}
